...
namespace Utilities2D
{
    public class MaterialManager
    {
        ...
        static private SmartMaterial GetVertexLit()
        {
            ...
            {
                if (Slicer2D.Settings.GetRenderingPipeline() == Slicer2D.Settings.RenderingPipeline.Universal)
                {
